...
#define MEM_SIZE                    12288 //aumentei
...
#define LWIP_ICMP                   1
#define LWIP_RAW                    1
#define TCP_WND                     (8 * TCP_MSS)//aumentei
#define TCP_MSS                     1460
#define TCP_SND_BUF                 (8 * TCP_MSS) // Possível ajuste para aumentar o buffer de envio
#define TCP_SND_QUEUELEN            ((4 * (TCP_SND_BUF) + (TCP_MSS - 1)) / (TCP_MSS)) //Possível ajuste para aumentar o tamanho da fila de envio
